package com.util.xiejinpeng.xandroidarichitecture.util

import com.squareup.moshi.JsonAdapter
import com.squareup.moshi.Moshi
import com.squareup.moshi.Types
import com.util.xiejinpeng.xandroidarichitecture.manager.api.base.globalMoshi
...
inline fun <reified T> List<T>.listToJson(): String = ModelUtil.listToJson(this, T::class.java)
...
object ModelUtil {
    ...
    inline fun <reified S, reified T> copyModel(source: S): T? {
        return fromJson(toJson(any = source, classOfT = S::class.java), T::class.java)
    }
